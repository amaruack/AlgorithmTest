package com.example.naver2021;

import java.util.concurrent.LinkedBlockingDeque;
import java.util.concurrent.LinkedBlockingQueue;
import java.util.stream.Stream;

public class Example02_ex {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Example02_ex test = new Example02_ex();
        ...
        String[] ar7 = test.solution("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaab");
        String[] ar8 = test.solution("baaaaaaba");
    ...
    public String[] solution(String s) throws InterruptedException {
        ...
        // left queue
        LinkedBlockingQueue<String> leftQueue = new LinkedBlockingQueue<>();
        // right queue
        LinkedBlockingDeque<String> rightDeque = new LinkedBlockingDeque<>();
        // 분리
        recu(s, leftQueue, rightDeque);
        // 합치기
        answer = Stream.concat(leftQueue.stream(), rightDeque.stream()).toArray(String[]::new);
        return answer;
    }

    public static void recu(String s, LinkedBlockingQueue<String> leftQueue, LinkedBlockingDeque<String> rightDeque) throws InterruptedException {
        ...
        for (int i = 0; i < arrs.length; i++) {
            ...
            if (leftSb.toString().equals(rightSb.reverse().toString())) {
                ...
                recu(s.substring(i+1, arrs.length-i-1), leftQueue, rightDeque);
                break;
            }
